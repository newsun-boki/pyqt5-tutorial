'''
Author: your name
Date: 2021-12-03 01:04:20
LastEditTime: 2021-12-03 01:10:45
LastEditors: newsun-HP-Pavilion-Gaming-Laptop-15-dk0xxx
Description: In User Settings Edit
FilePath: /pyqt5/lesson2.py
'''
import sys
...
class AppIcon(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('/home/newsun/Pictures/1.png')) # 创建一个QIcon对象并接收一个我们要显示的图片路径作为参数。
        self.show()
